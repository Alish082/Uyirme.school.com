    ...
    <>
        ...
        <Box maw={340} mx="auto">
          ...
          >
            ...
            <MultiSelect
              ...
              nothingFoundMessage={
                <Button
                  style={{ backgroundColor: "#003a7d", color: "white" }}
                  onClick={() => {
                    form.setValues({
      ...
      <main className="min-h-screen bg-[#00000]">
        ...
        >
          ...
          >
            <a
              href="mailto:first.gfo.ohio@gmail.ru"
          ...
          >
            <a
              href="https://www.instagram.com/first.gfo?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              style={{ textDecoration: "none", color: "white" }}
            >
              Instagram
            </a>
